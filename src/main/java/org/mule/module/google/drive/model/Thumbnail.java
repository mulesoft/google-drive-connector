...
/**
 * Wrapper for class {@link com.google.api.services.drive.model.File.Thumbnail}
 * to make it DataMapper friendly
 * @author mariano.gonzalez@mulesoft.com
 *
 */
public class Thumbnail extends BaseWrapper<com.google.api.services.drive.model.File.Thumbnail> {
	
	public Thumbnail() {
		super(new com.google.api.services.drive.model.File.Thumbnail());
	}
	
	public Thumbnail(com.google.api.services.drive.model.File.Thumbnail wrapped) {
		super(wrapped);
	}
